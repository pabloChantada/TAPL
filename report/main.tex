...
\begin{itemize}
    ...
    \item \textbf{Módulo de Teoría con RAG (Retrieval-Augmented Generation)} \cite{rag_survey}: Vinculación del modelo Google Gemini \cite{gemini2023,google-genai-sdk} con una base de datos bibliográfica. Esto permite generar explicaciones teóricas fundamentadas, donde el usuario puede verificar la fuente original de la información, reduciendo además las alucinaciones del modelo. \footnote{Esta funcionalidad requiere la configuración de la API de GEMINI.}
...
git clone [https://github.com/pabloChantada/TAPL.git](https://github.com/pabloChantada/TAPL.git)
cd TAPL
\end{lstlisting}
